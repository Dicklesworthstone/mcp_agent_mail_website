...
export const tuiScreenCopy: TuiScreenCopy[] = [
  ...
  },
  {
    id: "screen-messages",
    screen: "Messages",
    coreQuestion: "Which coordination messages need attention?",
    primarySignals: ["importance", "ack required", "sender and project"],
  },
  {
    id: "screen-threads",
    screen: "Threads",
  ...
  },
  {
    id: "screen-search",
    screen: "Search",
    coreQuestion: "Which messages, agents, or projects match these facets?",
    primarySignals: ["cross-surface results", "facet filters", "thread and date scope"],
  },
  {
  ...
  },
  {
    ...
    screen: "Tool Metrics",
    coreQuestion: "Which tools and transports are hot or failing?",
    primarySignals: ["call volume", "error rate", "tail latency"],
  },
  {
    id: "screen-system-health",
    screen: "System Health",
    coreQuestion: "Are the database, queues, and connections healthy?",
    primarySignals: ["database health", "queue pressure", "connection probes"],
  },
  {
    id: "screen-timeline",
    screen: "Timeline",
    coreQuestion: "What happened, and in what order?",
    primarySignals: ["message lifecycle", "reservation changes", "event timestamps"],
  },
  {
    id: "screen-projects",
    screen: "Projects",
    coreQuestion: "Which projects are carrying the coordination load?",
    primarySignals: ["message counts", "agent counts", "reservation counts"],
  },
  {
    id: "screen-contacts",
    screen: "Contacts",
  ...
  },
  {
    id: "screen-explorer",
    screen: "Explorer",
    coreQuestion: "Which inbound or outbound messages match this operational slice?",
    primarySignals: ["direction", "grouping", "ack status"],
  },
  {
    id: "screen-analytics",
    screen: "Analytics",
    coreQuestion: "Which anomalies deserve investigation next?",
    primarySignals: ["confidence score", "actionable next step", "deep-linked evidence"],
  },
  {
    id: "screen-attachments",
    screen: "Attachments",
    coreQuestion: "Which attachment should I inspect, and where did it come from?",
    primarySignals: ["inline preview", "source provenance", "sender context"],
  },
  {
    id: "screen-archive-browser",
    screen: "Archive Browser",
    coreQuestion: "What does the canonical Git archive contain?",
    primarySignals: ["directory tree", "file preview", "audit trail"],
  },
  {
    id: "screen-atc",
    screen: "ATC",
    coreQuestion: "Are agents live, conflicting, and backed by decision evidence?",
    primarySignals: ["agent liveness", "conflict decisions", "evidence ledger"],
  },
];
...
export const credibilityHighlights: CredibilityHighlight[] = [
  ...
  },
  {
    ...
    metric: "TUI Screens",
    value: "16",
    context: "Full operational dashboard: messages, threads, reservations, agents, system health, and more",
    icon: "monitor",
  },
  {
    id: "ch-search-modes",
