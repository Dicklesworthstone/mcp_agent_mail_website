...
export const coverageMatrix: CoverageTarget[] = [
  // Routes
  {
    ...
    e2eTests: [
      ...
      "Terminal tabs, dashboard filters, Search, and replay rows accept keyboard and pointer input",
      "Zoom controls and fullscreen refit the live terminal without losing focus",
      ...
      "Reduced-motion: replay remains interactive with animation cadence reduced",
    ],
    priority: "critical",
  },
  {
