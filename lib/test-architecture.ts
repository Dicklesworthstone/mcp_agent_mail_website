...
export const coverageMatrix: CoverageTarget[] = [
  // Routes
  {
    ...
    unitTests: [
      ...
      "VideoObject JSON-LD output matches schema.org spec",
      "Credibility highlights render all items",
      "Adoption messages map to correct personas",
    ],
    e2eTests: [
      "Full page load and hero visible",
      "Video placeholder displays with poster and controls",
      "Chapter navigation opens and seeks correctly",
      ...
      "Reduced-motion: video replaced by static poster",
    ],
    priority: "critical",
  },
  {
  ...
  },
  {
    ...
    unitTests: [
      ...
      "Chapter markers cover full video duration without gaps",
      "Media packaging spec filenames match videoPlaceholder paths",
    ],
    e2eTests: [],
    priority: "high",
  },
