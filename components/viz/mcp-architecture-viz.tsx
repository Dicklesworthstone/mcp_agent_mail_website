        ...
        <div className="relative z-10 grid w-full min-w-0 gap-4 xl:grid-cols-2 2xl:grid-cols-[1fr_1.4fr_1.15fr]">
          ...
          <article className="min-w-0 rounded-xl border border-white/10 bg-black/60 p-5 shadow-xl backdrop-blur-md">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 leading-tight">Agent Clients</p>
            </div>
            <div className="space-y-3">
              ...
              <div className="mt-4 border-t border-slate-800 pt-4">
                 <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 leading-tight">Active Protocol Envelope</p>
          ...
          <article className="min-w-0 rounded-xl border p-5 shadow-2xl backdrop-blur-md flex flex-col justify-center transition-colors duration-500 overflow-hidden xl:order-3 xl:col-span-2 2xl:order-none 2xl:col-span-1" style={{ backgroundColor: `${flow.accent}15`, borderColor: `${flow.accent}50` }}>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-lg border border-white/10 bg-black/40 p-4">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2 flex items-center gap-1 leading-tight"><Layers className="w-3 h-3" /> MCP Tool Layer</p>
              ...
              <div className="rounded-lg border border-white/10 bg-black/40 p-4">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2 flex items-center gap-1 leading-tight"><Shield className="w-3 h-3" /> Coordination Core</p>
          ...
          <article className="min-w-0 rounded-xl border border-white/10 bg-black/60 p-5 shadow-xl backdrop-blur-md xl:order-2 2xl:order-none">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 leading-tight">Storage Layer</p>
            </div>
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-white/5 bg-black/40 p-3">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2 leading-tight">Guarantees Applied</p>
