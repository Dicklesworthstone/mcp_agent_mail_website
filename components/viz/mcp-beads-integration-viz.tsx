    ...
    <VizSurface aria-label="MCP Beads Integration">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-slate-400">
          Agent Mail tightly integrates with the 'br' tracking system, linking file locks and messages directly to issue IDs.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className={`${vizPanelClassName} p-5 flex items-center justify-between border-slate-700/50`}>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-200">3. Complete & Release</p>
