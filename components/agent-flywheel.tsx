...
export default function AgentFlywheel() {
  ...
  return (
    <div className="relative px-4 pt-24 pb-32 sm:px-6 md:px-8 md:py-32 xl:px-0">
      <AnimatePresence>
        {isGlitching && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <SyncContainer withPulse={true} className="mx-auto max-w-[1600px] overflow-hidden bg-black/60 border-white/5 shadow-[0_0_150px_rgba(0,0,0,0.8)] lg:overflow-visible">
        ...
        <div className="grid items-stretch gap-0 lg:grid-cols-[1fr,1.5fr] xl:grid-cols-[1fr,1.8fr]">
          {/* THE REACTOR STAGE */}
          <div className="relative flex min-h-[380px] items-center justify-center overflow-hidden p-6 sm:min-h-[440px] md:min-h-[560px] md:p-10 lg:min-h-[700px] lg:overflow-visible lg:border-r lg:border-white/5 lg:p-12">
            <NeuralFragments />

            <div className="relative h-[300px] w-[300px] sm:h-[360px] sm:w-[360px] md:h-[510px] md:w-[510px] xl:h-[600px] xl:w-[600px]">
              <div
                className="absolute left-0 top-0 origin-top-left scale-50 sm:scale-[0.6] md:scale-[0.85] xl:scale-100"
              ...
              <div className="absolute" style={{ left: CENTER - 80, top: CENTER - 80, width: 160, height: 160 }}>
                ...
                {flywheelTools.map((tool, i) => {
                  ...
                  return (
                    ...
                    >
                      <AnimatePresence>
                        {isDesktop && isHovered && !selectedId && (
          ...
          <div className="relative flex h-full min-h-[420px] flex-col overflow-hidden bg-white/[0.01] md:min-h-[520px] lg:min-h-[700px]">
            <div className="absolute top-0 left-0 right-0 h-px bg-white/5 lg:hidden" />

            <AnimatePresence mode="wait">
              {selectedTool && isDesktop ? (
                <motion.div
                  key={selectedTool.id}
                ...
                >
                  <div className="relative shrink-0 overflow-hidden border-b border-white/5 bg-white/[0.02] p-6 md:p-10 xl:p-12">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 relative z-10">
                      ...
                      <div className="flex shrink-0 items-center gap-6 rounded-2xl border border-white/5 bg-black/40 p-5 shadow-inner md:gap-8 md:p-6">
                  ...
                  <div className="custom-scrollbar flex-1 overflow-y-auto bg-black/20 p-6 md:p-10 xl:p-12">
                  ...
                  <div className="relative shrink-0 border-t border-white/5 bg-black/40 p-6 md:p-10 xl:p-12">
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="relative flex h-full flex-col items-center justify-center space-y-8 p-6 text-center sm:p-8 md:space-y-10 md:p-12 lg:p-20"
                >
                  <div className="absolute top-6 left-6 h-8 w-8 border-t border-l border-white/10 md:top-12 md:left-12 md:h-12 md:w-12" />
                  <div className="absolute top-6 right-6 h-8 w-8 border-t border-r border-white/10 md:top-12 md:right-12 md:h-12 md:w-12" />
                  <div className="absolute bottom-6 left-6 h-8 w-8 border-b border-l border-white/10 md:bottom-12 md:left-12 md:h-12 md:w-12" />
                  <div className="absolute bottom-6 right-6 h-8 w-8 border-b border-r border-white/10 md:bottom-12 md:right-12 md:h-12 md:w-12" />
                  ...
                  <div className="relative z-10 max-w-lg space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-5xl font-black text-white uppercase tracking-tighter leading-none sm:text-6xl md:text-7xl">
                        The AI <br /> <span className="text-animate-blue">Flywheel.</span>
                      </h3>
                      <p className="px-2 text-lg font-medium leading-relaxed italic text-slate-400 opacity-60 sm:px-6 md:px-8 md:text-xl">
                        &ldquo;{flywheelDescription.subtitle}&rdquo;
                      </p>
                    </div>
                    <div className="group relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-black/40 p-6 shadow-inner md:p-8">
                    ...
                    <div className="grid grid-cols-3 gap-4 pt-6 md:gap-8 md:pt-8">
                    ...
                    <div className="mt-8 space-y-5 border-t border-white/5 pt-8 md:mt-10 md:pt-10">
        ...
        <div className="pointer-events-none absolute top-6 right-8 hidden items-center gap-4 opacity-30 md:flex">
          <motion.div
      ...
      <BottomSheet isOpen={!!selectedId && !isDesktop} onClose={() => setSelectedId(null)} title={selectedTool?.name}>
        {selectedTool && (
